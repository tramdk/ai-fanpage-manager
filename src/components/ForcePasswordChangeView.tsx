  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-8 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-slate-900/40 backdrop-blur-3xl p-10 rounded-[48px] border border-slate-800/60 shadow-3xl ring-1 ring-white/5 animate-in zoom-in-95 duration-500">
          ...
          {!success ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2 group">
                <label className="block text-[9px] font-bold text-slate-500 uppercase tracking-widest ml-2">Mật khẩu mặc định hiện tại</label>
                <div className="relative">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-600 group-focus-within:text-red-400 transition-colors" />
                  <input
                    type="password"
                    required
                    value={currentPassword}
                    onChange={(e) => setCurrentPassword(e.target.value)}
                    className="w-full bg-slate-950 border-2 border-slate-800 rounded-2xl pl-12 pr-6 py-4 text-white focus:outline-none focus:border-red-600 transition-all font-bold placeholder:text-slate-800 text-sm"
                    placeholder="••••••••••••"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2 group">
                <label className="block text-[9px] font-bold text-slate-500 uppercase tracking-widest ml-2">Mật khẩu bảo mật mới</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border-2 border-slate-800 rounded-2xl pl-12 pr-6 py-4 text-white focus:outline-none focus:border-emerald-600 transition-all font-bold placeholder:text-slate-800 text-sm"
              ...
              <div className="space-y-2 group">
                <label className="block text-[9px] font-bold text-slate-500 uppercase tracking-widest ml-2">Xác nhận mật khẩu</label>
                <input
                  type="password"
                  required
                  value={confirmPassword}
                  onChange={(e) => setConfirmPassword(e.target.value)}
                  className="w-full bg-slate-950 border-2 border-slate-800 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-emerald-600 transition-all font-bold placeholder:text-slate-800 text-sm"
            ...
            <div className="py-10 flex flex-col items-center">
              ...
              <p className="text-slate-400 text-xs font-bold uppercase tracking-widest animate-pulse">Initializing Neural Secure Tunnel...</p>
            </div>
          )}
        </div>
      </div>
