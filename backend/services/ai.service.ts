...
const POST_TYPE_PROMPTS: Record<string, string> = {
  facebook_ad: `Định dạng bài viết: Bài đăng Facebook Ads / Bán hàng trực tiếp cô đọng, cuốn hút (đọc khoảng 30s-60s).
Yêu cầu cấu trúc:
1. TIÊU ĐỀ (HOOK): Giật gân, khơi gợi tò mò hoặc đánh trúng nỗi đau khách hàng ngay 3 giây đầu, kèm emoji phù hợp và nổi bật.
2. NỖI ĐAU & KHÁT KHAO: Phác họa thật ngắn gọn vấn đề nhức nhối mà khách hàng gặp phải.
3. GIẢI PHÁP & LỢI ÍCH CỐT LÕI (USP): Giới thiệu sản phẩm trong hình như một giải pháp tuyệt vời. Liệt kê 2-3 tính năng/lợi ích đắt giá nhất, miêu tả sinh động cảm giác sướng khi sử dụng.
4. KÊU GỌI HÀNH ĐỘNG (CTA): Rõ ràng, dứt khoát, thôi thúc nhắn tin hoặc bấm mua ngay.
5. 3-5 Hashtag độc đáo và thịnh hành để tăng lượt tiếp cận.`,

  product_review: `Định dạng bài viết: Đánh giá (Review) sản phẩm chân thực, súc tích nhưng đầy cảm hứng (đọc khoảng 30s-60s).
Yêu cầu cấu trúc:
1. MỞ ĐẦU CUỐN HÚT: Ấn tượng đầu tiên cực mạnh khi chạm mắt sản phẩm này trong hình vẽ/ảnh chụp (về thiết kế, màu sắc, packaging).
2. TRẢI NGHIỆM GIÁC QUAN NHANH (SENSORY REVIEW): Kịch bản sử dụng thực tế ngắn gọn (cảm nhận bề mặt chất liệu, mùi hương hoặc tính năng vận hành trơn tru).
3. ĐIỂM CỘNG LỚN NHẤT (USP): Đánh giá sâu sắc ưu điểm vượt trội làm bạn thích thú nhất.
4. ĐỐI TƯỢNG PHÙ HỢP & LỜI KHUYÊN: Khuyên cụ thể ai nên sở hữu sản phẩm này ngay.
5. 3-5 Hashtag review liên quan.`,

  storytelling: `Định dạng bài viết: Storytelling (Kể chuyện thương hiệu/Khách hàng giàu cảm xúc, chạm sâu vào trái tim nhưng cực kỳ ngắn gọn trong 30s-60s).
Yêu cầu cấu trúc:
1. TÌNH HUỐNG đời thường vô cùng gần gũi, khó khăn hay khoảnh khắc bế tắc mà khách hàng thường gặp phải.
2. BƯỚC NGOẶT: Sự xuất hiện đầy ấn tượng của sản phẩm (nhân vật chính trong hình) giải quyết triệt để vấn đề đó.
...
Yêu cầu cấu trúc:
1. Lời mở đầu đầy thu hút về sản phẩm.
2. 2-3 điểm cộng tuyệt đối của sản phẩm được phân tích từ hình ảnh.
3. Lời kêu gọi hành động mua hàng kèm các hashtag sản phẩm thịnh hành.`
};
...
YÊU CẦU VỀ ĐỘ DÀI VÀ TỐI ƯU THỜI GIAN:
- Độ dài bài viết/kịch bản: BẮT BUỘC phải cô đọng, súc tích, đọc hoặc nói trôi chảy trong khoảng 30 giây - 60 giây (tương đương khoảng 100 - 150 từ, tuyệt đối KHÔNG vượt quá 180 từ).
- Chọn lọc ngôn từ đắt giá, đi thẳng vào trọng tâm, tuyệt đối không rườm rà, lặp ý hay dài dòng lê thê.
- Phân tích kỹ bức ảnh để mô tả chính xác, chân thực nhưng đầy chất thơ và tính thuyết phục.
- Trình bày trực quan, dùng câu ngắn, ngắt dòng thông minh để tạo nhịp điệu đọc nhanh và cuốn hút.
\n`;
